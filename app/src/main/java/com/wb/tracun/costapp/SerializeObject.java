...
import com.wb.tracun.costapp.Interfaces.ISerializeObject;
import com.wb.tracun.costapp.model.*;
...
public class SerializeObject implements ISerializeObject{
    ...
    @Override
    public Produto WriteSerializeObject(Produto produto, String name, File dir) {
    ...
    @Override
    public Produto readSerializeObject(Produto produto, String name, File dir) {
